...
| **Type Piano** | A complete free virtual piano whose computer-keyboard, native MIDI, and on-screen 88-key inputs share one performance state, realtime synth, and source-attested streamed grand-piano bank. | [Repository](https://github.com/hannes-wan/type-piano-official) · [Product](https://hannes-software.com/type-piano/) |
